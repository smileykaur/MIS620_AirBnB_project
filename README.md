...
These two data sets had to be joined on the common field UserID
This study employed a binary variable, Country Destination (DF = 1, NDF= 0), as the response variable. 
